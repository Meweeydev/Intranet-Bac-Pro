        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scrill-to-section"><a href="calandrier.php">Calandrier</a></li>

              <li class="scroll-to-section"><a href="administ.php">Administration</a></li>

              <li><div class="gradient-button"><a id="modal_trigger" href="#modal"><i class="fa fa-sign-in-alt"></i> Mon Compte</a></div></li> 
            </ul>        
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <h2>Bienvenue, sur la page d'administration de  <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b></h2>
                    <p>Vous pouvez modifier certaine chose.</p>
                  </div>
                  <div class="col-lg-12">
...
<div class="form-group">
    <input type="password" name="password_retype" class="form-control" placeholder="Rettaper le mot de passe" required="required" autocomplete="off">
</div>
    <div class="form-group">
